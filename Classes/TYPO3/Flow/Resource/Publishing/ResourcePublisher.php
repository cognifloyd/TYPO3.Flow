...
class ResourcePublisher {
	 ...
	 *
	 * IMPORTANT: This method merely exsists in order to simplify migration from earlier versions of Flow which still
	 * provided this method. This method has never been part of the public API and will be removed in Flow 3.0.
	 *
	 * Note that, depending on your Resource Collection setup, this method will not always return the correct base URI,
	 * because as of Flow 2.1 there can be multiple publishing targets for static resources and URIs of the respective
	 * target might not work by simply concatening a base URI with the relative file name.
	 *
	 * This method will work for the default Flow setup using only the local file system.
	 *
	 * Make sure to refactor your client code to use the new resource management API instead. Don't use this method.
